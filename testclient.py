...
player1 = Player(player1interim.cooldown,player1interim.bullet_interim_list,player1interim.vertical_velocity,player1interim.is_in_air,player1interim.can_jump,player1interim.is_alive,player1interim.update_timer,player1interim.player_type,player1interim.players_action,player1interim.action_number,player1interim.flip,player1interim.x,player1interim.y)
...
while game_is_running:
    ...
    if len(player1.bullet_interim_list) >= 1:
        bullet = Bullet(player1.bullet_interim_list[0].x,player1.bullet_interim_list[0].y,player1.bullet_interim_list[0].targetx,player1.bullet_interim_list[0].targety,screen)
        bullet_group_player1.add(bullet)
    bullet_group_player1.draw(screen)
    bullet_group_player1.update()
    player1.draw(screen)
    debug(player1.cooldown,10,10)
